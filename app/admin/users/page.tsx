                    ...
                    {resetting === user.id ? (
                      <div className="flex gap-2 items-center">
                        <input
                          ...
                          className="px-3 py-1.5 text-sm text-gray-900 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none"
                          autoFocus
                        />
                        <button
